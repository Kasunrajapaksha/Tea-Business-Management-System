            ...
            <div class="col-md-3 col-xl-3" id="settings-panel" >
                ...
                <div class="card">
                    ...
                    <div class="text-center mb-5">
                        <img src="{{ $user->image ? asset('storage/' . $user->image) : asset('admin_asset/img/avatars/avatar.jpg')}}"
                    ...
                    <div class="list-group list-group-flush" role="tablist">
                        <a class="list-group-item list-group-item-action disabled" data-bs-toggle="list" href="#account"
                            role="tab">
                            Account
                        </a>
                        ...
                        <a class="list-group-item list-group-item-action disabled" data-bs-toggle="list" href="#password"
                            role="tab">
                            Password
                        </a>
                    ...
                    {{-- <div class="tab-pane fade" id="image" role="tabpanel"> --}}
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.update.image', $user) }}" method="POST" enctype="multipart/form-data" id="image-upload-form">
                                    @csrf
                                    @method('patch')
                                    <div class="mb-3">
                                ...
                                <form action="{{ route('admin.destroy.image',$user) }}" method="POST" id="delete-image" hidden>
                                    @csrf
                                    @method('delete')
                                </form>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.reset.password') }}" method="POST">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @error('current_password')
                                                <p class="text-danger text-sm m-0 p-0">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" class="form-control" name="password" id="inputPasswordNew">
                                            @error('password')
                                                <p class="text-danger text-sm m-0 p-0">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label class="form-label col-md-3" for="password_confirmation">Verify password</label>
                                        <div class="col-md-9">
                                            <input type="password" class="form-control" name="password_confirmation" id="inputPasswordNew2">
