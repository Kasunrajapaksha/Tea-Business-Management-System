<x-app-layout>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('shipping.vessel.update',$vessel) }}" method="post">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="vessel_name" value="{{ $vessel->vessel_name}}">
                                    <x-error field="vessel_name" />
                                </div>
                                <div class="mb-3 col-md-12">
                                    <label  class="form-label" for="tracking_number">Tracking Number</label>
                                    <input type="text" class="form-control" name="tracking_number" value="{{ $vessel->tracking_number}}">
                        ...
                        <div class="d-flex align-items-center justify-content-start">
                            <a href="{{ route('shipping.vessel.show',$vessel) }}" class="btn btn-secondary mt-2">Close</a>
                        ...
                        <div class="modal fade" id="addProvider" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                ...
                                <div class="modal-body">
                                    <h4>Are you sure you want to update this vessel?</h4>
                                </div>
