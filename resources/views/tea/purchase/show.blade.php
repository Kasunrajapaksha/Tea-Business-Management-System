                    ...
                    <form action="{{ route('production.material.purchase.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="units" class="form-label">Tea Purchase No</label>
                                <input type="text" class="form-control" id="units" name="units" value="{{ $purchase->tea_purchase_no }}" disabled>
                                <x-error field="units" />
                            </div>
                            <div class="mb-3 col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="material_id" class="form-label">Tea Type</label>
                                <select class="form-control" id="material_id" name="material_id" disabled>
                                    <option value="">{{ $purchase->tea->tea_name }}</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="units" class="form-label">Units (Kg)</label>
                                <input type="text" class="form-control" id="units" name="units" value="{{ $purchase->quantity }}" disabled>
                                <x-error field="units" />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="unit_price" class="form-label">Price Per Kg (LKR)</label>
                                <input type="text" class="form-control" id="unit_price" name="unit_price" value="{{ $purchase->tea->price_per_Kg }}" disabled>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                @endcan
                                @can('update', $purchase)
                                <a href="{{ route('tea.purchase.edit', $purchase ) }}" class="btn btn-primary mt-2">Edit Purchase</a>
                                @endcan
                            </div>
                        </div>
